...
resource "aws_security_group" "rds" {
  ...
  # Allow external access for POC (allows data population from local machine)
  ingress {
    description = "PostgreSQL from anywhere (POC only)"
    from_port   = 5432
    to_port     = 5432
    protocol    = "tcp"
...
# DB Subnet Group (Public - for POC accessibility)
resource "aws_db_subnet_group" "public" {
  name        = "${var.project_name}-db-subnet-group-public"
  description = "Public subnet group for RDS instances (POC only)"
